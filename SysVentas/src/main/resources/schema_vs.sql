...
ALTER TABLE upeu_usuario ADD CONSTRAINT IF NOT EXISTS upeu_perfil_usuario_fk
    FOREIGN KEY (id_perfil)
    REFERENCES upeu_perfil (id_perfil);

ALTER TABLE upeu_compra ADD CONSTRAINT IF NOT EXISTS upeu_proveedor_compra_fk
    FOREIGN KEY (id_proveedor)
    REFERENCES upeu_proveedor (id_proveedor);

ALTER TABLE upeu_producto ADD CONSTRAINT IF NOT EXISTS upeu_unid_medida_producto_fk
    FOREIGN KEY (id_unidad)
    REFERENCES upeu_unid_medida (id_unidad);

ALTER TABLE upeu_compra ADD CONSTRAINT IF NOT EXISTS upeu_usuario_compra_fk
    FOREIGN KEY (id_usuario)
    REFERENCES upeu_usuario (id_usuario);

ALTER TABLE upeu_venta ADD CONSTRAINT IF NOT EXISTS upeu_usuario_venta_fk
    FOREIGN KEY (id_usuario)
    REFERENCES upeu_usuario (id_usuario);

ALTER TABLE upeu_vent_carrito ADD CONSTRAINT IF NOT EXISTS upeu_usuario_carrito_fk
    FOREIGN KEY (id_usuario)
    REFERENCES upeu_usuario (id_usuario);

ALTER TABLE upeu_comp_carrito ADD CONSTRAINT IF NOT EXISTS upeu_usuario_comp_carrito_fk
    FOREIGN KEY (id_usuario)
    REFERENCES upeu_usuario (id_usuario);

ALTER TABLE upeu_compra_detalle ADD CONSTRAINT IF NOT EXISTS upeu_compra_compra_detalle_fk
    FOREIGN KEY (id_compra)
    REFERENCES upeu_compra (id_compra);

ALTER TABLE upeu_venta ADD CONSTRAINT IF NOT EXISTS upeu_cliente_venta_fk
    FOREIGN KEY (dniruc)
    REFERENCES upeu_cliente (dniruc);

ALTER TABLE upeu_venta_detalle ADD CONSTRAINT IF NOT EXISTS upeu_venta_venta_detalle_fk
    FOREIGN KEY (id_venta)
    REFERENCES upeu_venta (id_venta);

ALTER TABLE upeu_producto ADD CONSTRAINT IF NOT EXISTS upeu_marca_producto_fk
    FOREIGN KEY (id_marca)
    REFERENCES upeu_marca (id_marca);

ALTER TABLE upeu_producto ADD CONSTRAINT IF NOT EXISTS upeu_categoria_producto_fk
    FOREIGN KEY (id_categoria)
    REFERENCES upeu_categoria (id_categoria);

ALTER TABLE upeu_compra_detalle ADD CONSTRAINT IF NOT EXISTS upeu_producto_compra_detalle_fk
